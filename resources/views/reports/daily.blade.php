...
@section('content')
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-semibold text-slate-50">Daily Sales Report</h1>
        ...
        <form method="GET" class="mb-6 flex items-center gap-4">
            <input type="date" name="date" value="{{ $date }}"
                class="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-slate-50">
            <button type="submit"
        ...
        <div class="bg-slate-800 rounded-2xl overflow-hidden shadow-lg">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-slate-400">No invoices found for this date.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
